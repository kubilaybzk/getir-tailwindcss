...
function Footer() {
  ...
  return (
    <div className="min-h-[400px] mt-8">
      <div className="w-[400] relative overflow-hidden p-4">
        <input
          type="checkbox"
          className="absolute top-0 inset-x-0 w-full h-12 opacity-0  cursor-pointer peer !border-none"
        />
        <h1 className="text-primary-brand-color text-lg -mt-2">
          Getir'i indirin!
        </h1>
        <AiOutlineArrowDown className="text-primary-brand-color text-2xl absolute top-3 right-3  transition-transform duration-500 rotate-0 peer-checked:rotate-180 " />
        <div className="bg-white overflow-hidden transition-all duration-500 max-h-0 peer-checked:max-h-max">
          <section className="mx-auto mt-5 flex justify-center">
            <nav className="grid gap-y-4">
              {/* <h6 className="text-lg text-primary-brand-color mx-auto">
                Getir'i indirin!
              </h6>*/}
              <a href="#">
      ...
      {menus.map((item2, key) => {
        return (
          <div className="h-[400] relative overflow-hidden p-4">
            <input
              type="checkbox"
              className="absolute top-0 inset-x-0 w-full h-12 opacity-0  cursor-pointer peer !border-none"
            />
            ...
            <AiOutlineArrowDown className="text-primary-brand-color text-2xl absolute top-3 right-3  transition-transform duration-500 rotate-0 peer-checked:rotate-180 " />
            <div className="bg-white overflow-hidden  max-h-0 peer-checked:max-h-max peer-checked:ease-in peer-checked:duration-300">
      ...
      <div className="flex justify-around flex-wrap gap-y-4 items-center border-t border-gray-100 mt-6 py-6">
 ...
 <div className="bg-white mt-10">
      <div className="container mx-auto">
        <div className="grid grid-cols-2">
          ...
          {menus.map((item2, key) => {
            return (
              <section key ={key} className="mx-auto mt-5">
                <nav className="grid gap-y-4">
                  <h6 className="text-lg text-primary-brand-color">{item2.title}</h6>
                  <nav>
                    <ul className="grid gap-y-2">
